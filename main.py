...
def main(config_file):
    ...
    exporttoexcel(jobs_to_add)
    
def cleandata():
    data = pd.read_csv('jobs.csv')
    data.columns = ['Title','Company','Country','Date Published','Link','Job Description','Applied','Hidden','Interviewed','Rejected']
    data.drop(data.loc[data['Job Description']== 'Could not find Job Description'].index, inplace=True)
